...
namespace DataAccess.Domain
{
	...
	/// </summary>
	[Serializable]
	public sealed class MenuReplace
	{
		...
		{
			get { return _replaceno; }
			set	
			{
				if( value!= null && value.Length > 30)
					throw new ArgumentOutOfRangeException("Invalid value for ReplaceNo", value, value.ToString());
				
				_isChanged |= (_replaceno != value); _replaceno = value;
			}
		}
